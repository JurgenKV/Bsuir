...
#define COLOR_COUNT 7 //kolichestvo cvetov
...
{ 0x71,0x62,0x43,0x54,0x35,0x26,0x17 }; //massiv cvetov dlya videobuffera
...
void initialize()
{
	...
	setvect(0xDE, newint0D);  //set new handler for IRQ 5
	setvect(0xDF, newint0E);  //set new handler for IRQ 6
	setvect(0xE1, newint0F);  //set new handler for IRQ 7
